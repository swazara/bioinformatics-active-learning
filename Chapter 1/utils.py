"""
Chapter 1 algorithm suite from "Bioinformatics Algorithms: An Active Learning Approach".
k-mer analysis, skew minimization, and clump finding unified into a single module
with shared utilities, complexity annotations, and visualization support.
Consolidation made with assistance from Claude.
